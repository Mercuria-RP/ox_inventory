return {
	...
	VendingMachineSnacks = {
		...
		model = {
			`prop_vend_snak_01`, `prop_vend_snak_01_tu`, `prop_vend_water_01`, `prop_vend_soda_01`
		}
	},

	MechanicGarage = {
		name = 'Magasin du garage',
		groups = {
			['mechanic'] = 0
		},
		inventory = {
			{ name = 'repair_kit',      price = 60 },
			{ name = 'diagnostic_tool', price = 30 },
			{ name = 'sponge',          price = 10 }

		},
		locations = {
			vec3(-196.658, -1315.380, 31.089)
		},
		targets = {
			{ loc = vec3(-196.658, -1315.380, 31.089), length = 0.6, width = 3.5, heading = 240.0, minZ = 49.8, maxZ = 50.2, distance = 30.0 }
		}
	}
}
